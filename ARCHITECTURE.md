...
### 2.3. Módulo de Composição & Linha do Tempo (NLE) Avançada (v2.4)
...
- **Snap Magnético (0.5s Grid):** Mecânica matemática de snap mapeada nas interações de arraste e trim na linha do tempo. Quando o snap está ativo, a posição temporal computada é arredondada para o incremento de `0.5` segundos mais próximo, garantindo transições e alinhamentos milimétricos com a grade temporal.
